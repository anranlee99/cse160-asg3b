...
class Vector3 {
    ...
    add(other) {
        ...
        for (let [i, v]  of Object.entries(other.elements)) {
          this.elements[i] += v;
        }
    ...
    static cross(other1, other2) {
        ...
        const v3 = new Vector3([cx, cy, cz]); // Modify this line to calculate cross product between other1 and other2.
        // Don't delete the return statement.
        return v3;
    }
    ...
    normalize() {
        ...
        for (let [i, v] of Object.entries(this.elements)) {
          this.elements[i] = v / magnitude;
        }
        // Don't delete the return statement.
        return this;
    };
